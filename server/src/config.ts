...
export class Config {
  ...
  'jhipster.mail.from' = 'eLab@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'eLab API';
  'jhipster.swagger.description' = 'eLab API documentation';
  ...
  'eureka.instance.appname' = 'eLab';
  'eureka.instance.instanceId' = 'eLab:${random.value}';
