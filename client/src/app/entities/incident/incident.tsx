...
import { getEntities, reset } from './incident.reducer';
    ...
    <div>
      <h2 id="incident-heading" data-cy="IncidentHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/incident/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('mitigationAction')}>
                  ...
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td className="text-end">
                      <div className="btn-group flex-btn-group-container">
                        ...
                        <Button tag={Link} to={`/incident/${incident.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                          <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Ubah</span>
                        </Button>
                        <Button
                          onClick={() => (window.location.href = `/incident/${incident.id}/delete`)}
                          color="danger"
                          size="sm"
