...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './usage-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USAGELOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USAGELOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USAGELOG actions', async () => {
      const arg = { id: 27437 };
    ...
    it('dispatches UPDATE_USAGELOG actions', async () => {
      const arg = { id: 27437 };
    ...
    it('dispatches PARTIAL_UPDATE_USAGELOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USAGELOG actions', async () => {
      const arg = 42666;
