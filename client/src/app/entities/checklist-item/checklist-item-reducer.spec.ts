...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHECKLISTITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHECKLISTITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHECKLISTITEM actions', async () => {
      const arg = { id: 5519 };
    ...
    it('dispatches UPDATE_CHECKLISTITEM actions', async () => {
      const arg = { id: 5519 };
    ...
    it('dispatches PARTIAL_UPDATE_CHECKLISTITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHECKLISTITEM actions', async () => {
      const arg = 42666;
