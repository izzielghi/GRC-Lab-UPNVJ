...
import reducer, {
  ...
  reset,
  updateEntity,
} from './maintenance-record.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAINTENANCERECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAINTENANCERECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAINTENANCERECORD actions', async () => {
      const arg = { id: 63 };
    ...
    it('dispatches UPDATE_MAINTENANCERECORD actions', async () => {
      const arg = { id: 63 };
    ...
    it('dispatches PARTIAL_UPDATE_MAINTENANCERECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAINTENANCERECORD actions', async () => {
      const arg = 42666;
