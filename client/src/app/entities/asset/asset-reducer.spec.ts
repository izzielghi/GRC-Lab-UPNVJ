...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './asset.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSET actions', async () => {
      const arg = { id: 17131 };
    ...
    it('dispatches UPDATE_ASSET actions', async () => {
      const arg = { id: 17131 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSET actions', async () => {
      const arg = 42666;
