...
import reducer, {
  ...
  reset,
  updateEntity,
} from './compliance-record.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLIANCERECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPLIANCERECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPLIANCERECORD actions', async () => {
      const arg = { id: 31985 };
    ...
    it('dispatches UPDATE_COMPLIANCERECORD actions', async () => {
      const arg = { id: 31985 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPLIANCERECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPLIANCERECORD actions', async () => {
      const arg = 42666;
