...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECORDITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECORDITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECORDITEM actions', async () => {
      const arg = { id: 16332 };
    ...
    it('dispatches UPDATE_RECORDITEM actions', async () => {
      const arg = { id: 16332 };
    ...
    it('dispatches PARTIAL_UPDATE_RECORDITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECORDITEM actions', async () => {
      const arg = 42666;
