...
import reducer, {
  ...
  reset,
  updateEntity,
} from './compliance-checklist.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLIANCECHECKLIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPLIANCECHECKLIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPLIANCECHECKLIST actions', async () => {
      const arg = { id: 419 };
    ...
    it('dispatches UPDATE_COMPLIANCECHECKLIST actions', async () => {
      const arg = { id: 419 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPLIANCECHECKLIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPLIANCECHECKLIST actions', async () => {
      const arg = 42666;
