...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sop.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOP actions', async () => {
      const arg = { id: 21732 };
    ...
    it('dispatches UPDATE_SOP actions', async () => {
      const arg = { id: 21732 };
    ...
    it('dispatches PARTIAL_UPDATE_SOP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOP actions', async () => {
      const arg = 42666;
