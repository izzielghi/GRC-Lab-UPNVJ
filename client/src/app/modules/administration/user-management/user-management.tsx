      ...
      <h2 id="user-management-page-heading" data-cy="userManagementPageHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="new" className="btn btn-primary jh-create-entity">
            <FontAwesomeIcon icon="plus" /> Buat pengguna baru
          </Link>
        </div>
      </h2>
        ...
        <thead>
          <tr>
            ...
            <th className="hand" onClick={sort('createdDate')}>
              Dibuat tanggal <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
            </th>
            <th className="hand" onClick={sort('lastModifiedBy')}>
              Diubah oleh <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
            </th>
            <th id="modified-date-sort" className="hand" onClick={sort('lastModifiedDate')}>
              Diubah tanggal <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedDate')} />
            </th>
            <th />
          </tr>
        </thead>
